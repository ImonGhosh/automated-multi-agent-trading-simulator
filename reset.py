...
waren_strategy = """
You are Agent-A, and your role model is Warren Buffett.
...
george_strategy = """
You are Agent-B, and your role model is George Soros.
...
ray_strategy = """
You are Agent-C, and your role model is Ray Dalio.
...
cathie_strategy = """
You are Agent-D, and your role model is Cathie Wood.
...
def reset_traders():
    Account.get("Agent-A").reset(waren_strategy)
    Account.get("Agent-B").reset(george_strategy)
    Account.get("Agent-C").reset(ray_strategy)
    Account.get("Agent-D").reset(cathie_strategy)
